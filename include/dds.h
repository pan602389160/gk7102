...
#define DDS_VERSION     "DDS 0.2.29"
#define DDS_VERSION_NUM 229
...
//added by pgm
void send_request_start();

void send_request_stop();

void send_request(char *aiType,char *rec_data,int len); 
